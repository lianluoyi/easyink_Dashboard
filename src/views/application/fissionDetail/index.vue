  ...
  <div class="task-detail-container">
    <div class="task-detail-model task-detail-left">
      ...
      <div class="task-row" style="margin-bottom:30px">
        ...
        <img v-if="taskDetail.rewardImageUrl" style="width:30px" :src="taskDetail.rewardImageUrl">
      </div>
      <div class="task-row">
    ...
    <div class="task-detail-model task-detail-right">
      ...
      <div class="dateRang">
        <el-radio-group v-model="dateSelect" @change="dateChange">
      ...
      <div id="chartLineBox" style="width: 100%;height: 354px;" />
    </div>
  </div>
</template>
