...
<template>
  <div class="content-item">
    <el-form ref="verbalTrickItemForm" class="content-form-item" :model="item" label-width="0" :disabled="disabled">
        ...
        <div class="item-div">
          ...
          <div v-if="item.isDefined !== DEFAULT_LINK">
            ...
            <UploadDrag
              ...
              :disabled-edit="disabled"
            />
            <VerbalTrickImgLink :title="item.title" :content="item.content" :cover-url="item.coverUrl" />
          </div>
          <div v-else>
            <el-form-item label-width="0" prop="url">
              <el-input
