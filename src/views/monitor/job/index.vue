    ...
    <RightContainer>
      ...
      <template v-slot:operate-btn>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button v-hasPermi="['monitor:job:remove']" size="mini" @click="handleDelete">批量删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button size="mini" @click="handleJobLog">执行日志</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['monitor:job:export']" size="mini" @click="handleExport">导出任务</el-button>
          </el-col>
        </el-row>
      </template>
