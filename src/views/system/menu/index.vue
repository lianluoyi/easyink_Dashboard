      ...
      <template v-slot:search>
        <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true">
          ...
          <el-form-item prop="status">
            <el-select v-model="queryParams.status" placeholder="请选择菜单开启状态" clearable size="small">
              <el-option
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col v-if="['C', 'P'].includes(form.menuType)" :span="12">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      this.confirmModal(
        {
          msg: '即将删除菜单项“' + row.menuName + '”，删除后系统将不再显示，是否继续？'
        },
        () => {
